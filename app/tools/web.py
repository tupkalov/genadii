...
register(
    Tool(
        name="web_search",
        description=(
            "Поиск в интернете. Используй для актуальных фактов, новостей, цен, курсов, "
            "результатов событий — всего, чего нет в твоих знаниях или что могло устареть. "
            "При малейшей неуверенности в конкретном факте (дата, цифра, событие) — "
            "лучше проверить здесь, чем угадать по памяти."
        ),
        parameters={
            "type": "object",
            "properties": {
