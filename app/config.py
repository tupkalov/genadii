...
class Settings(BaseSettings):
    ...
    # Промпт-кэш (Anthropic через OpenRouter): ставим cache_control на стабильный
    # префикс (системный промпт + история) — чтения из кэша ~в 10× дешевле.
    # Выгодно нам: вход огромный из-за повторяющегося контекста и tool-циклов.
