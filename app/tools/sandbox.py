...
register(
    Tool(
        ...
        description=(
            ...
            "и данным бота; есть интернет). Пиши полный скрипт, результат печатай "
            "в stdout. Доступны: стандартная библиотека, requests, httpx, "
            "beautifulsoup4. Лимиты: 30 сек, 512 МБ. Состояние между запусками "
            "не сохраняется."
        ),
        parameters={
            "type": "object",
